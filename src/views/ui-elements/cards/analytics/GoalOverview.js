      ...
      <Card>
        ...
        <div className="d-flex mt-2">
          <div className="completed border-top border-right text-center w-50 py-1">
            <p className="mb-50">Market Cap</p>
            <p className="font-large-1 text-bold-600 mb-50">$520B</p>
          </div>
          <div className="in-progress border-top border-right text-center w-50 py-1">
            <p className="mb-50">24hr Volume</p>
            <p className="font-large-1 text-bold-600 mb-50">$145B</p>
          </div>
        </div>
      </Card>
    );
