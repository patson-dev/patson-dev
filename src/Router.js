...
import Spinner from "./components/@dev/spinner/Loading-spinner";
...
const avatar = lazy(() => import("./components/@dev/avatar/Avatar"));
const AutoComplete = lazy(() =>
  import("./components/@dev/autoComplete/AutoComplete")
);
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          />
          <AppRoute path="/ecommerce/checkout" component={checkout} />
          ...
          <AppRoute path="/misc/coming-soon" component={comingSoon} />
          <AppRoute path="/misc/error/404" component={error404} />
          <AppRoute path="/pages/login" component={Login} />
          <AppRoute path="/pages/register" component={register} />
          <AppRoute path="/pages/forgot-password" component={forgotPassword} />
          <AppRoute path="/pages/lock-screen" component={lockScreen} />
          <AppRoute path="/pages/reset-password" component={resetPassword} />
          <AppRoute path="/misc/error/500" component={error500} />
          <AppRoute path="/misc/not-authorized" component={authorized} />
          <AppRoute path="/misc/maintenance" component={maintenance} />
